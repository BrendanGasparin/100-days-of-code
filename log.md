...
I've also been doing Zenva's Intro to Godot Mini-Degree. So I've been learning GDScript and the Godot Engine.  
...
**Today's progress:** Modified cryptography site. Added labels to the UI elements, made website responsive on both mobile and larger screens, and added descriptions for each type of cipher.  

**Thoughts:** Not much to do here now except add more encryption algorithms.  
...
**Thoughtss:** For JS Cryptography, I still need to add labels to the fields, clipboard copy buttons for mobile users, and I should tighten up the UI and make it more responsive between desktop and mobile devices.  
...
**Thoughts:** I need to add labels to the plaintext, ciphertext, and ciphers. I also need to add substitution cipher encryption, and clipboard copy buttons for mobile phone users.  
...
**Thoughts:** I spent half an hour on top of the hour of code tracking down a bug in my code. I was taking the user input for the ROT number as a string when I needed to parse it into an int. I have to implement an error message when the user tries to encrypt without selecting an algorithm. Then I will implement ROT decryption.
...
**Today's Progress:** Troubleshooted my inability to fork the 100 days of code repository. Wrote this log. Updated my cybersecurity resources list.  
...
**Link(s) to work:**  
1. [100 Days of Code Log](https://github.com/BrendanGasparin/100-days-of-code)  
2. [List of Cybersecurity Resources](https://github.com/BrendanGasparin/list-cybersecurity-resources)  
